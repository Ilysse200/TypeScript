const compile = (input: string): string => {
    ...
    const transformFunction = (input: string): string => {
        const transformParameters = (params: string): string => {
        ...
        const replacement = (match: string, accessModifier: string | undefined, async: string, returnType: string, funcName: string, params: string, body: string): string => {
    ...
    const transformVariable = (input: string): string => {
        ...
        const replacement = (match: string, declarationKeyword: string, asyncKeyword: string, type: string, arrayBrackets: string, name: string, arrowValue: string, value: string) => {
    ...
    const transformAwait = (input: string): string => {
        ...
        const replacement = (match: string, args: string) => `await new Promise<void>(${args})`;
    ...
    const transformInterface = (input: string): string => {
        ...
        const replacement = (match: string, name: string, properties: string) => {
    ...
    const transformObjectAssignment = (input: string): string => {
    ...
    const transformInterfaceProperty = (input: string): string => {
    ...
    const transformComplexTypes = (input: string): string => {
    ...
    // Helper function to transform interface definitions
    const transformTypeAlias = (input: string): string => {
    ...
    const transformClassVariables = (input: string): string => {
